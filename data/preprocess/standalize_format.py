...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default='yt2t', choices=['yt2t', 'msrvtt2016', 'msrvtt2017', 'tvvtt', 'msvd'], help='Choose dataset')
    ...
    if args.dataset == 'msrvtt2016' or args.dataset == 'msvd':
